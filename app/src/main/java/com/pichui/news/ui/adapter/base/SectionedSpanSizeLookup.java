...
public class SectionedSpanSizeLookup extends GridLayoutManager.SpanSizeLookup {
    ...
    protected BaseSectionedRecyclerViewAdapter<?, ?, ?> adapter = null;
    protected GridLayoutManager layoutManager = null;

    public SectionedSpanSizeLookup(BaseSectionedRecyclerViewAdapter<?, ?, ?> adapter, GridLayoutManager layoutManager) {
