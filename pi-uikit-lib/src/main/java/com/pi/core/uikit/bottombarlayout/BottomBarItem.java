package com.pi.core.uikit.bottombarlayout;
...
public class BottomBarItem extends LinearLayout {
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@linkunreadNumThreshold}则隐藏，
     *                  大于0小于{@linkunreadNumThreshold}则显示对应数字，
     *                  超过{@linkunreadNumThreshold}
     *                  显示{@linkunreadNumThreshold}+
     */
